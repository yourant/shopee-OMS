  ...
  children: [
    {
      ...
      meta: { title: '自动回复模板', icon: 'template-manage', permission: 'operation.auto-reply.auto-reply-template.list' }
    },
    {
      path: '/autoReply/tools',
      component: () => import('@/views/autoReply/tools'),
      name: 'autoReply.tools',
      meta: { title: '辅助工具', icon: 'box', permission: 'operation.chat-statistics.auto-reply-rate' }
    },
    // ,
    // {
