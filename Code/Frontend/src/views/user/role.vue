  ...
  export default {
    ...
    data() {
      return {
        ...
        permissions: {
          add: 'operation.manager.role.add',
          edit: 'operation.manager.role.edit',
          delete: 'operation.manager.role.delete',
          enable: 'operation.manager.role.enable',
          accredit: 'operation.manager.role.permission'
        },
        listLoading: true,
        listTotal: null,
        listData: [],
